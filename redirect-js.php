...
<head>
    <script>
        if(document.location.href.indexOf('redirect=fin')>-1) {
            //do nothing
        } else  {
            window.location.replace("redirect-js.php" + document.location.search + (document.location.search.indexOf('?')>-1  ? '&redirect=fin' : '?redirect=fin'));
        }
    </script>
