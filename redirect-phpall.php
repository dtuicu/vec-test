...
//Parameter attached to the END of the URL
function preserve_qs2() {
    if (empty($_SERVER['QUERY_STRING']) && strpos($_SERVER['REQUEST_URI'], "?") === false) {
        return "?redirect=true";
    }
    return "?" . $_SERVER['QUERY_STRING'] . '&redirect=true';
}

header("Status: 301 Moved Permanently");
header("Location: redirect-phpall-fin.php" . preserve_qs2());
?>
<!doctype html>
<html lang="en">
<head>
